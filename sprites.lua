...
sprites.walk_right1 = love.graphics.newImage('Sprites/Player/adventurer_right_walk1.png')
sprites.walk_right2 = love.graphics.newImage('Sprites/Player/adventurer_right_walk2.png')
